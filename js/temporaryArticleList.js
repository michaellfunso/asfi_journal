...
function UpdateTemporaryArticles(ArticleLst, currentPage, totalPages) {
  ...
  <div class="share-options" style="display: none;">
    <ul class="rlist--inline separator">
      <li title="Share on ASFIScholar" class="shareOption" data-platform="asfischolar" aria-label="Share on ASFIScholar"><img src="./images/ASFIScholar_Logo.png" alt="" width="64px" height="34px"></li>
