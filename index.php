...
<body class="header-1 business">
	...
	">
			...
			<div class="article-side">
				...
				<div style="display: flex; justify-content: space-around; margin-bottom: 20px;">
					<a href="http://facebook.com/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" x="0px"
							y="0px" width="40" height="40" viewBox="0 0 50 50">
							<path
								d="M25,3C12.85,3,3,12.85,3,25c0,11.03,8.125,20.137,18.712,21.728V30.831h-5.443v-5.783h5.443v-3.848 c0-6.371,3.104-9.168,8.399-9.168c2.536,0,3.877,0.188,4.512,0.274v5.048h-3.612c-2.248,0-3.033,2.131-3.033,4.533v3.161h6.588 l-0.894,5.783h-5.694v15.944C38.716,45.318,47,36.137,47,25C47,12.85,37.15,3,25,3z">
							</path>
						</svg>facebook</a>
					<a href="http://linkedin.com/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" x="0px"
							y="0px" width="40" height="40" viewBox="0 0 50 50">
							<path
								d="M41,4H9C6.24,4,4,6.24,4,9v32c0,2.76,2.24,5,5,5h32c2.76,0,5-2.24,5-5V9C46,6.24,43.76,4,41,4z M17,20v19h-6V20H17z M11,14.47c0-1.4,1.2-2.47,3-2.47s2.93,1.07,3,2.47c0,1.4-1.12,2.53-3,2.53C12.2,17,11,15.87,11,14.47z M39,39h-6c0,0,0-9.26,0-10 c0-2-1-4-3.5-4.04h-0.08C27,24.96,26,27.02,26,29c0,0.91,0,10,0,10h-6V20h6v2.56c0,0,1.93-2.56,5.81-2.56 c3.97,0,7.19,2.73,7.19,8.26V39z">
							</path>
						</svg>linkedin</a>
					<a href="http://instagram.com/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" x="0px"
							y="0px" width="40" height="40" viewBox="0 0 50 50">
							<path
	...
	<!-- <section class="article-section bd-bottom padding">
<div class="container" id="articleListContainer"></div>
</section> -->
	...
	<div class="section-heading mb-40 text-center wow fadeInUp" data-wow-delay="200ms">
		<h4><span></span>Our Recent Events<span></span></h4>
		<h2>RECENT EVENTS</h2>
	</div>
	<div class="row investment-plans">
		<div class="col-lg-12 col-sm-12 sm-padding wow fadeInUp" data-wow-delay="200ms">
			<div class="service-item text-center">
				<div class="events-section" id="events-section">
					<div class="events-header">
						<h3><a href="./events.html" class="browse-all-link">Browse all &rarr;</a></h3>
					</div>
					<div class="recent-events-wrapper">
						<div class="recent-events-carousel">
							<div class="recent-events-items">
								<div class="event-info">
									<a href="#"><h4>ASFI 2023 Virtual Multidisciplinary Conference & Boot Camp</h4></a>
									 <p>November 2023</p>
								</div>
								...
								<div class="event-video-frame">
									...
									<iframe width="100%" height="100%" src="https://www.youtube.com/embed/M0DZeo7c4cA?si=4UaMSUglLqjzC_0X" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
								</div>
						...
						<div class="recent-events-carousel-dots">
						</div>
	...
	<section class="cta-section bg-grey">
		<div class="container">
			<div class="row cta-wrap">
				...
				<!-- <div class="cta-img d-none d-md-block">
				
					<iframe width="100%" height="315" src="https://www.youtube.com/embed/w5TynGMJ1SI?si=7eaWWsuXpH9xBiWz?autoplay=1" frameborder="0" allowfullscreen></iframe>
	...
	<section class="why-section about-section bd-bottom padding" id="why-section">
		<div class="why-header">
			<h2 class="h3">Why Publish in <span>ASFIRJ?</span></h2>

			<div class="why-info">
				Rapid & Transparent publishing for African Scholars & Researchers.
			</div>
		</div>


		<div class="why-items-bg wow fadeInLeft" data-wow-delay="200ms">
			<div class="why-items">
				<div class="jog">
					<div class="why-item">
						...
						<div class="sub-text">
							<span>High Quality Peer Review</span>
							<span>With ASFIRJ, expect high quality and prompt peer review and editorial assessment of
								all submissions, accepting only articles that meet the highest scientific standards.
								<span>
						</div>
					</div>
				</div>
					...
					<div class="why-item">
						...
						<div class="sub-text">
							...
							<span>Our affordable article processing charges for perpetual open access, which are very
								modest, with judicious discounts for ASFI members.</span>
						</div>
					</div>
				</div>
				...
				<div class="jog">
					<div class="why-item">
						...
						<div class="sub-text">
							<span>Immediate Social Media Attention</span>
							<span>All accepted submission are immediately promoted across all ASFIRJ, ASFIScholar, and
								ASFI social media platforms.</span>
						</div>
					</div>
				...
				<div class="jog">
					<div class="why-item">
						...
						<div class="sub-text">
							<span>Multidisciplinarity</span>
							<span>Publishes papers from any field of research and encourages multidisciplinary and
								interdisciplinary collaborations.</span>
						</div>
					</div>
				...
				<div class="jog">
					<div class="why-item">
						...
						<div class="sub-text">
							<span>High-quality editorial process</span>
							<span>ASFIRJ editors are tested and dedicated scholars who ensure high quality editorial
								processes. <span>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-3 col-sm-6 sm-padding">
						<div class="footer-widget">
							...
							<p>
								At ASFIRJ, we prioritize our publishers' expectations. With clear guidance, we ensure
								effective management and delivery. Join us in upholding excellence in research
								publishing.
							</p>
						</div>
					</div>
					...
					<div class="col-lg-3 col-sm-6 sm-padding">
						<div class="footer-widget link-widget">
							<h3>Editor</h3>
							<ul class="widget-links">
								<li><i class="fas fa-square-full"></i><a href="./editors.html"
										class='menu-item'>Editors</a></li>
							</ul>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 sm-padding">
						<div class="footer-widget link-widget">
							<h3>About</h3>
							<ul class="widget-links">
								<li><i class="fas fa-square-full"></i><a href="./aboutus.html" class='menu-item'>About
										Us</a></li>
								<li><i class="fas fa-square-full"></i><a
										href="https://africansciencefrontiers.com/">African Science Frontiers
										Initiatives</a></li>
								<li><i class="fas fa-square-full"></i><a href="https://asfischolar.org/">ASFIScholar</a>
								</li>
							</ul>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 sm-padding">
						<div class="footer-widget link-widget">
							<h3>Useful Links</h3>
							<ul class="widget-links">
								<li><i class="fas fa-square-full"></i><a href="./events.html"
										class='menu-item'>Events</a></li>
								<li><i class="fas fa-square-full"></i><a href="./terms.html">Terms &amp; Conditions</a>
								</li>
					...
					<div class="col-lg-3 col-sm-6 sm-padding" id="news">
						<div class="footer-widget">
...
================================================== -->
		...
		<!-- <script type="text/javascript">        window.jQuery || document.write('<script src="assets/js/vendor/jquery.min.html"><\/script>')</script> -->
